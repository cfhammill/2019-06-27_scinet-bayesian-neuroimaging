...
- If you restart your session for any reason, you'll need to re-run the `.libPaths` command. 
  Note that rendered slides cannot be viewed from within the singularity container.
