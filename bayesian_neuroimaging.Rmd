...
singularity exec \
  ...
  /scinet/course/ss2019/3/8_bayesianmri/RMINC-rserver-scinet-2019-06-26.imgXS \
  rserver \
  --auth-none 0 \
...
- Can we use all of this extra information somehow?
...
```{r, fig.height=3}
hpc$Do(function(x){
  x$ad <- -log10(x$stats %>% filter(term=="dxAD") %>% 
                   select(p.value))
})
