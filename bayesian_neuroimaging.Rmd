...
.remark-slide-number {
  ...
  margin-right: 10px;
  color: #FFFFFF; /* white */
  opacity: 0; /* deConverging function, structure and behavioural features of emotion regulation in very preterm childrenfault: 0.5 */
}
</style>
...
1. Setup rstudio
1. Remind you about classical statistics
1. Introduce you to Bayesian statistics
1. Compare Bayesian and Frequentist linear model on simulated data
1. Introduce some real neuroimaging data
1. Demonstrate univariate analyses
1. Demonstrate massively-univariate analyses
1. Introduce hierarchical modelling
1. Work through one (two if we're lucky) example

---

# Following Along

- To follow along we're going to use a singularity container on the scinet teach cluster
  to run RStudio server. This gives you full featured RStudio in your browser.
- You can in theory run on your own laptop, but you will need to install a lot
  of packages. Not recommended.
  
---

# Get connected

- These instructions assume you will be running on the scinet teach cluster

```{r, engine = "bash", eval = FALSE}
ssh -L8787:localhost:<your-port> <you>@teach.scinet.utoronto.ca

git clone https://github.com/cfhammill/2019-06-27_scinet-bayesian-neuroimaging
cd 2019-06-27_scinet-bayesian-neuroimaging
...
- To run the rstudio server you will need to set up a reverse tunnel
